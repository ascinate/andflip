...
function NewPost() {
    const newpoext =[
        {id:1, titel:"Which social media software is suitable for marketing?", imgs:"images/blogs-user.png", commnet:"7", useid:"Alex Kim", reply:"13", time:"13h ago",  page:"/commentdetails" },
        {id:2, titel:"What's your favorite AI project in product hunt?", imgs:"images/blogs-user.png", commnet:"7", useid:"Alex Kim", reply:"13", time:"13h ago",  page:"/commentdetails" },
